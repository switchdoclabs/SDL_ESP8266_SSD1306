...
class SDL_ESP8266_SSD1306 : public Adafruit_GFX  {
 public:
  SDL_ESP8266_SSD1306(int8_t SID, int8_t SCLK, int8_t DC, int8_t RST, int8_t CS);
  SDL_ESP8266_SSD1306(int8_t DC, int8_t RST, int8_t CS);	//Constructor for hardware SPI
  SDL_ESP8266_SSD1306(int8_t RST);
