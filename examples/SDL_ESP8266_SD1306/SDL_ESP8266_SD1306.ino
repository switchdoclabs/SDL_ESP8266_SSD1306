// Modified by SwitchDoc Labs to work with ESP8266
/*
 ****** ESP_ssd1306_128x64_I2C demo display *********
 *
 * Demo for using SDL_ESP8266_SSD1306 library to communicate
 ...
 *
 * This examples uses the SDL_ESP8266_SSD1306 library which is a copy of the default's Adafruit_SSD1306
...
#include <SDL_ESP8266_SSD1306.h>    // Modification of Adafruit_SSD1306 for ESP8266 compatibility
#include <MAdafruit_GFX.h>   // Needs a little change in original Adafruit library (See README.txt file)
...
SDL_ESP8266_SSD1306 display(OLED_RESET); // FOR I2C
